...
ggplot(filtered_data, aes(x = Tag, y = logFC, fill = Regulation)) +
  ...
  theme(
    ...
    plot.background = element_rect(fill = "transparent", color = NA),   # Background of the transparent panel
    legend.background = element_rect(fill = "transparent")              # Background of the transparent panel
  ) +
